...
from environments import IterationEnvironment
from models import create_iterator_model

#TODO: Make these values inputs taken by the post model server (not n)
EPISODE_LENGTH = 1000
EPISODES = 1000
ANNEAL_PERIOD = 100
MEMORY = 20000
...
def train_iteration_model(modelName):
    # print("Running2")
    # x = 0
    ...
    model = create_iterator_model(actions)
